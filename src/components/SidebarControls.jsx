...
import { FileUp, Download, LayoutTemplate, Monitor, Trash2, Images } from 'lucide-react';
...
export function SidebarControls({
    ...
    // For mobile, we render without the outer container styling
    const content = (
        <div className={cn("space-y-6", !isMobile && "flex-1")}>
    ...
    // Mobile version - just return the content
    if (isMobile) {
        return content;
    }

    // Desktop version - with full sidebar wrapper
    return (
